...
public class NPBlockTagsProvider extends BlockTagsProvider {
    ...
    protected void addTags() {
        ...
        this.tag(BlockTags.SAPLINGS).add(NPBlocks.GLOW_SAPLING.get(), NPBlocks.CYCAS_SAPLING.get());
        ...
        this.tag(BlockTags.LOGS).addTag(NPBlockTags.GLOW_LOGS).addTag(NPBlockTags.CYCAS_LOGS);
    }
