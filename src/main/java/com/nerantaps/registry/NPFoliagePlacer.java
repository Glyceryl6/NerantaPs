...
import com.nerantaps.level.levelgen.feature.tree.foliage.MapleFoliagePlacer;
...
public class NPFoliagePlacer {
    ...
    public static final RegistryObject<FoliagePlacerType<MapleFoliagePlacer>> MAPLE_FOLIAGE_PLACER = register("maple", MapleFoliagePlacer.CODEC);
