...
public class IronSnailModel<T extends IronSnail> extends EntityModel<T> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        shell.addOrReplaceChild("shell_r1", CubeListBuilder.create().texOffs(0, 0)
                .addBox(-1.0F, -15.0F, -5.0F, 1.0F, 17.0F, 10.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition head = partDefinition.addOrReplaceChild("head", CubeListBuilder.create().texOffs(16, 21)
                .addBox(-3.0F, 0.0F, -4.0F, 4.0F, 3.0F, 6.0F,
                        new CubeDeformation(0.0F)), PartPose.offset(0.0F, 21.0F, 0.0F));
        ...
        partDefinition.addOrReplaceChild("ass", CubeListBuilder.create().texOffs(16, 21)
                .addBox(-2.0F, -1.0F, 0.0F, 4.0F, 3.0F, 6.0F,
                        new CubeDeformation(0.0F)), PartPose.offset(-1.0F, 22.0F, 2.0F));
