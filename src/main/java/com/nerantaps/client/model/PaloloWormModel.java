    ...
    public static LayerDefinition createBodyLayer() {
        ...
        meshDefinition.getRoot().addOrReplaceChild("part4", CubeListBuilder.create().texOffs(0, 13)
                ...
                .addOrReplaceChild("part5", CubeListBuilder.create().texOffs(0, 13)
                        ...
                        .addBox(-5.0F, 1.0F, -0.5F, 2.0F, 8.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false),
                ...
                .addOrReplaceChild("tail", CubeListBuilder.create().texOffs(18, 4).mirror()
                        .addBox(-2.0F, 24.0F, -2.0F, 4.0F, 6.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false),
                ...
                .addOrReplaceChild("part3", CubeListBuilder.create().texOffs(0, 13)
                        ...
                        .addBox(-5.0F, -8.0F, -0.5F, 2.0F, 8.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false),
                ...
                .addOrReplaceChild("part2", CubeListBuilder.create().texOffs(0, 0)
                        ...
                        .addBox(-5.0F, -9.0F, -0.5F, 2.0F, 8.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false),
                ...
                .addOrReplaceChild("right", CubeListBuilder.create().texOffs(0, 28).mirror()
                        ...
                        .addBox(-2.75F, -0.75F, 0.0F, 4.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false),
                        PartPose.offset(-2.25F, -3.75F, -0.3333F));
